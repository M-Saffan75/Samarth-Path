const bg_here = require('../all_images/bg.png')
const app_logo = require('../all_images/logo.png')
const image_1 = require('../all_images/image-1.png')
...
const logout_icon = require('../all_images/logout.png')

const user_filled = require('../../icons/Filled/user.png')
const phone_filled = require('../../icons/Filled/phone.png')
...
const arrow_icon = require('../../images/all_images/arrow.json')
...
const share_icon = require('../../images/all_images/send.png')
const red_cross = require('../../images/all_images/red_cross.png')
const guidnace_icon = require('../../images/all_images/utilization.png')
const quiz_icon = require('../../images/all_images/quiz.png')
...
export const globalImages = {
    ...
    archive_light, access_light, user_light, logout_icon, share_icon,
